...
export type NAVBARS1Type = {
  className?: string;
};

const NAVBARS1: FunctionComponent<NAVBARS1Type> = ({ className = "" }) => {
  return (
    <header
    ...
    >
      ...
      <div className="w-[951px] flex flex-row items-end justify-start py-0 pr-0.5 pl-0 box-border gap-[32px] max-w-full mq725:gap-[16px] mq1050:hidden">
        ...
        <div className="flex flex-row items-start justify-start pt-2.5 px-2.5 pb-0">
          <a className="[text-decoration:underline] relative font-bold text-[inherit] whitespace-nowrap">
            LIST YOUR PROPERTY
          </a>
        </div>
        <div className="flex flex-row items-start justify-start pt-2.5 px-2.5 pb-0">
        ...
        <div className="flex flex-col items-start justify-start py-0 pr-2 pl-0">
          <div className="flex flex-row items-start justify-start pt-2.5 px-2.5 pb-0">
            <a className="[text-decoration:none] relative font-bold text-[inherit] inline-block min-w-[42px]">
              MORE
            </a>
          </div>
        </div>
